 ...
 * TODO: Merge it with the framework android.preference.SeekBarVolumizer with the changes:
 * 1. Always enable voice call stream even "total silence" is set.
 * 2. Do not start sample for voice call stream.
 *
 * @hide
 */
public class SeekBarVolumizer implements OnSeekBarChangeListener, Handler.Callback {
    ...
    protected void updateSeekBar() {
        ...
        mSeekBar.setEnabled(mStreamType == AudioManager.STREAM_VOICE_CALL || !zenMuted);
        if (zenMuted) {
    ...
    private void onInitSample() {
        ...
        if (mRingtone != null && mStreamType != AudioManager.STREAM_ACCESSIBILITY) {
    ...
    private void postStartSample() {
        ...
        mHandler.sendMessage(mHandler.obtainMessage(MSG_START_SAMPLE));
    }
    ...
    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromTouch) {
        if (progress == 0
            ...
            // Voice call / HFP stream should not be set to zero.
            progress = 1;
