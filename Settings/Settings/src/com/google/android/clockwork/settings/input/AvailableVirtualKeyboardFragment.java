...
public final class AvailableVirtualKeyboardFragment extends PreferenceFragment
    ...
    public void onSaveInputMethodPreference(final InputMethodPreference pref) {
        InputMethodAndSubtypeUtil.saveInputMethodSubtypeList(this, getContext().getContentResolver(),
                mImm.getInputMethodList(), false);
    ...
    private void updateInputMethodPreferenceViews() {
        ...
        Collections.sort(mInputMethodPreferenceList, (lhs, rhs) -> lhs.compareTo(rhs, collator));
