...
public class RemoteBugreportActivity extends Activity {
    ...
    // Let tests override; this is a useful convenience since UserHandle.SYSTEM is @hide
    // and sendBroadcastAsUser() isn't shadowed.
    @VisibleForTesting
    void sendBroadcastAsSystem(Intent intent) {
