...
/**
 * Shows links to enabled virtual keyboard's settings activities.
 * The last item opens the AvailableVirtualKeyboardFragment
 */
public final class VirtualKeyboardFragment extends SettingsPreferenceFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.prefs_virtual_keyboard_settings);
