...
oneway interface INetworkQueryService {
     ...
     */
    void startNetworkQuery(in INetworkQueryServiceCallback cb, in int phoneId) = 0;
     ...
     */
    void stopNetworkQuery(in INetworkQueryServiceCallback cb) = 1;
     ...
     * RIL.
     */
    void unregisterCallback(in INetworkQueryServiceCallback cb) = 2;
}
